        ...
        <section id="why-us" class="why-us">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>SKYE CUBE</h2>
                    <p>Dengan sistem dan strategi pembelajaran yang kami miliki mampu membangkitkan Rich Mentality
                        (Mental Kaya), mengasah Rich Intelligence (Skill Kaya), serta menumbuhkan Mature Leadership
                        (Kepemimpinan Yang Matang), dan Good Personality (Kepribadian Yang Baik). Kubus Skye diambil
                        dari filosofi Sunda yaitu masagi (persegi/kubus) yang mengandung makna manusia yang paripurna,
                        ilmunya luhur, pribadinya baik, mentalnya kuat, fisiknya kuat dan mampu memimpin dengan adil dan
                        bijaksana.</p>
                </div>

                <div class="row g-0" data-aos="fade-up" data-aos-delay="200">

                    <div class="col-xl-5 img-bg" style="background-image: url('../front/img/why-us-bg.jpg')"></div>
                        ...
                        <div class="slides-1 swiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <h3 class="mb-3">MATURE LEADERSHIP</h3>
                                        {{-- <h4 class="mb-3">A Mature Leader is Created, Not Born</h4> --}}
                                        <p>Kepemimpinan yang matang, adil, bijaksana, yang mampu men-influence dan
                                            men-drive orang lain</p>
                                    </div>
                                </div><!-- End slide item -->

                                <div class="swiper-slide">
                                    <div class="item">
                                        <h3 class="mb-3">NOBLE PERSONALITY</h3>
                                        {{-- <h4 class="mb-3">Kepribadian yang baik dan islami, yang tersusun oleh pola pikir dan pola sikap yang baik</h4> --}}
                                        <p>Kepribadian yang baik dan islami, yang tersusun oleh pola pikir dan pola
                                            sikap yang baik</p>
                                    </div>
                                </div><!-- End slide item -->
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <h3 class="mb-3">RICH INTELLIGENCE</h3>
                                        {{-- <h4 class="mb-3">Necessitatibus voluptatibus explicabo dolores a vitae voluptatum.</h4> --}}
                                        <p>Dibutuhkan tools dan teknik (ilmu-ilmu terupdate bisnis) agar impian kita
                                            terwujud dalam kenyataan</p>
                                    </div>
                                </div><!-- End slide item -->

                                <div class="swiper-slide">
                                    <div class="item">
                                        <h3 class="mb-3">RICH MENTALITY</h3>
                                        {{-- <h4 class="mb-3">Tempora quos est ut quia adipisci ut voluptas. Deleniti laborum soluta nihil est. Eum similique neque autem ut.</h4> --}}
                                        <p>Mental kuat dan optimisme terlatih untuk menjadi seorang entrepreneur</p>
                                    </div>
                                </div><!-- End slide item -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
                        <div class="phone-wrap">
                            <img src="../front/img/iphone.png" alt="Image" class="img-fluid">
                        </div>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="post-box">
                            <div class="post-img"><img src="../front/img/blog/blog-4.jpg" class="img-fluid"
                                    alt=""></div>
                            <div class="meta">
